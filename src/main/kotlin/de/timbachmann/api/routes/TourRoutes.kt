...
fun Route.tourRouting() {
    ...
    route("/tours") {
        ...
        post("/generate") {
            ...
            val queryTermEmbedding = QueryTerm(listOf("globalcolor"), QueryTerm.Type.TEXT, searchQuery)
            ...
            val multimediaObjects = if (distinctIds.size >= 10) { distinctIds.subList(0, 9) } else { distinctIds }
